...
**Figure placeholder:**
<img
  src="/images/lectures/class-18/pure-rotation.png"
  alt="Pure rotational flow pattern"
  loading="lazy"
  class="figure"
/>
...
**Figure placeholder:**
```md
![Focus of Expansion (FOE)](/images/lectures/class-18/foe.png)
```
...
**Figure placeholder:**
```md
![Aperture problem illustration](/images/lectures/class-18/aperture-problem.png)
```
