...
title: "Linear/Non-Linear Regression in the Browser"
...
3. Cubic regression
4. Degree-5 polynomial regression

All models are fitted to the *same dataset* (same RNG seed and generation procedure). In every plot, the fitted curve is drawn in a **golden line** to visually distinguish it from the scatter.
...
Parameters are computed using the closed-form least square solution:
